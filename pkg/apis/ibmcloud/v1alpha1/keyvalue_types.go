...
func (v *KeyValue) ToJSON(ctx context.Context) (interface{}, error) {
...
func ValueToJSON(ctx context.Context, valueFrom KeyValueSource) (interface{}, error) {
	if valueFrom.SecretKeyRef != nil {
		data, err := resources.GetSecretValue(ctx, valueFrom.SecretKeyRef.Name, valueFrom.SecretKeyRef.Key, true)
		if err != nil {
			// Recoverable
		...
		data, err := resources.GetConfigMapValue(ctx, valueFrom.ConfigMapKeyRef.Name, valueFrom.ConfigMapKeyRef.Key, true)
		if err != nil {
			// Recoverable
