...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &openwhiskv1beta1.Trigger{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileTrigger) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	trigger := &openwhiskv1beta1.Trigger{}
	...
	if err != nil {
		if !retry {
			...
			if err := r.Status().Update(context, trigger); err != nil {
...
func (r *ReconcileTrigger) updateTrigger(context context.Context, obj *openwhiskv1beta1.Trigger) (bool, error) {
